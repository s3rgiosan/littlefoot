...
- "Try in WordPress Playground" README button backed by `.wp-playground/blueprint.json`, seeded with a published demo post whose Footnotes block renders as interactive littlefoot popovers on the frontend.
